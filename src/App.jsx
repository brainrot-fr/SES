...
export default function App() {
  ...
  useEffect(() => {
    document.documentElement.dataset.theme = darkMode ? THEME_DARK : '';
    localStorage.setItem(THEME_STORAGE_KEY, darkMode ? THEME_DARK : THEME_LIGHT);
  }, [darkMode]);

  // Initialize notifications and listen for taps
  useEffect(() => {
    (async () => {

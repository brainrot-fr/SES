 ...
 * Displays navigation links, theme toggle, and test notification button (on native)
 */
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        {/* Footer: Theme toggle + Test notification (native only) */}
        <div className="sidebar__footer">
          ...
          {Capacitor.isNativePlatform() && (
            <>
              ...
              {testStatus && (
                <p className="sidebar__test-status">{testStatus}</p>
              )}
            </>
          )}
        </div>

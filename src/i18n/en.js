...
export default {
  ...
  notificationScheduled:
    "Test notification scheduled! It should arrive shortly.",
  ...
  quranLoadError:
    "Could not load this Surah — check your connection and try again.",
  ...
  authUpgradeDesc:
    "Add your email so your progress and preferences survive a reinstall. This is optional — skip it and everything still works.",

...
export default {
  ...
  settingsLoading: "لوڈ ہو رہا ہے…",
  settingsAnonymousDesc:
    "آپ ایپ گمنام طور پر استعمال کر رہے ہیں۔ ای میل کے ذریعے ڈیٹا محفوظ کریں یا موجودہ اکاؤنٹ میں سائن ان کریں۔",
  settingsSignedInAs: "اس اکاؤنٹ سے سائن ان ہے",
